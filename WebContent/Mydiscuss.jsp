...
<div class="Bott">
    <div class="wrapper clearfix">
        <div class="zuo fl">
            ...
            <div><h4>我的活动</h4>
                <ul>
                    ...
                    <li class="on"><a href="toMydiscuss">我的交流</a></li>
                </ul>
                <h4>个人中心</h4>
                <ul>
        ...
        <div class="you fl">
            <div class="my clearfix"><h2 class="fl">我的交流</h2></div>
            <div class="dlist">
                <ul class="clearfix" id="pro">
                    <li class="on"><a href="#2">所有交流</a></li>
            ...
            <div class="sx clearfix">
                ...
                <c:forEach var="ud" items="${requestScope.udiscuss }">
                    <dl class="fl">
                        
                        <dd>${ud.discuss_content }</dd>
                        <dd>&nbsp;</dd>
                        <dd>发表时间：${ud.discuss_time }</dd>
                        </dd>
